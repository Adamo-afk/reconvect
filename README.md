...
│   ├── train_data.csv                 # Sequence definitions for training
│   ├── validation_data.csv            # Sequence definitions for validation
│   ├── test_data.csv                  # Sequence definitions for testing
...
├── extract_sequences.py               # Step 4: Find temporally continuous sequences
...
#### Step 4 — Extract temporally continuous sequences
...
```bash
python extract_sequences.py                              # 00–06 UTC (test)
python extract_sequences.py --hours 6 18 --output train_data.csv   # training
python extract_sequences.py --hours 18 24 --output validation_data.csv
```

Output: `our_data/train_data.csv`, `test_data.csv`, `validation_data.csv`
