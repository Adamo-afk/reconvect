...
**What it buys.** `<stem>_hysteresis.png` compares, per lead, the pooled hits, misses and false alarms of the raw decision (rainfall: the argmax class map; lightning: p ≥ LOW) with those of the post-processed one on the scope samples, as the change of each count and as the rates of both.
