...
| `mtg_opera_mtgmr_continuous` | `vis_06` | `opera_reflectivity` `opera_rainfall_rate` `ir_38` `ir_105` `wv_63` `wv_73` | `opera_rainfall_rate_hr` | rainfall regression [0,1], ÷ 70 mm/h |
